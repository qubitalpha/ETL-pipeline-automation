...
class LoadDBIceLandEarthquakes(DataModel):
...
class LoadSourceIceLandEarthquakes(LoadtoTest):
    @property
...
class TestIceLandEarthquakesETL(unittest.TestCase):

    @property
    def source_json(self):
        obj = LoadSourceIceLandEarthquakes()
        return obj.extract()

    @property
    def db_data(self):
        obj = LoadDBIceLandEarthquakes()
...
if __name__ == '__main__':
    print("Testing earthquakes done")
    unittest.main()